...
if (rewrite) {
  ...
  for (i in included.files) {
    ...
    if (status != "n" & !is.na(statAmerican)) {
...
By the second instance of hearing the target label [cf. @ota2016reduplicated], children reliably recognized the novel word-object mappings in all conditions, suggesting that toddlers succeeded in learning words from both consistent and variable labels. It is important to acknowledge, however, that our current findings cannot fully tease apart different explanations for why children successfully learned from all types of input. One possibility is that exposure to four repetitions of the standard word form was sufficient, regardless of the surrounding variants. Children may have "filtered out" [cf. @potter2019infants] atypical or unfamiliar forms, focusing on the consistent standard repetitions. This explanation is plausible in the context of this short in-lab experiment but contrasts with naturalistic evidence that CDS variants are common in children's early productive vocabularies [e.g., @frank2021variability; @laing2019role; @tardif2008baby] and are used more often than standard adult word forms in the first years of life [@casey2022doggy]. Because it was not feasible for us to also evaluate children's recognition of typical and atypical variants in the test phase given the length of the task, we cannot determine what children encoded about the label variants and how this information affected their word-recognition accuracy. Future work might further examine causal effects of exposure to label variants, such as improved long-term retention of word-object mappings [cf. @vlach2019learning] or better generalization to new label variants [cf. @regier2005emergence; @swingley2016two].
