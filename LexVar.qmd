...
Across many languages, child-directed speech (CDS) frequently includes "baby-talk" words that are unique, or at least highly specific, to this register [@bynon1968berber; @casagrande1948comanche; @ferguson1964baby; @han2023che; @mazuka2008japanese; @ota2018choo; @pye1986quiche; @sarvasy2025child]. Child-directed words are often variants of existing adult forms, involving phonological and/or morphological changes [e.g., *doggy* for *dog*, @moore2024wordform] or replacement by onomatopoeic forms [e.g., *woof-woof* as an alternate label for *dog*: @laing2017perceptual; @ota2018choo], though some share little to no overlap in form or meaning [e.g., *bunny* for *rabbit*: @soderstrom2007beyond]. While such child-directed variants are typically replaced by adult forms later in development [@casey2022doggy], evidence from prior studies indicates that, in the first years of life, multiple labels for the same referent are used seemingly interchangeably in children’s input [@caseyIPcorpus; @moore2024wordform]. In the present study, we investigate how such label variation impacts children's word learning.

The process of early word learning is traditionally framed as a one-to-one mapping problem---children learn to associate individual word forms (i.e., labels) with individual referents [e.g., @smith2008infant; @stevens2017pursuit; but see also @wojcik2022map]. Under this view, label variation could be considered "noise" in the learning signal. Indeed, children often avoid adopting a second label for a referent they already have a name for [i.e., the mutual exclusivity bias, @markman1988children; @markman2003use; @merriman1989mutual; but see also @mervis1994two]. Using multiple variants to label the exact same referent also violates the pragmatic assumption that unique word forms must not share the exact same meaning [i.e., the principle of contrast: @clark1988logic]. 

However, (American) English-hearing children both recognize [@potter2024frequent] and use [@casey2022doggy; @deak2001any] multiple labels for the same referent. Children's earliest learned words are associated with the most amount of label variation in their input [@caseyIPcorpus; @moore2024wordform]. Moreover, the presence of certain types of label variation in the input has been shown to correlate both with children's concurrent vocabulary size [@callanan2004multiple] and future vocabulary growth [@ota2018choo] as well as their earlier learning of individual words [@moore2024wordform]. Thus, young learners appear to successfully contend with---and potentially benefit from---label variation in their input.

One partial explanation for this counterintuitive pattern is that child-directed variants are more learnable than standard adult word forms. Reduplicated variants, which include repetition of full or partial syllables (e.g., *woof-woof*, *bow-wow*), are relatively common in CDS [though estimated rates vary substantially across languages, e.g., @han2023che; @mazuka2008japanese; @ota2018choo]. Ota and Skarabela [-@ota2016reduplicated] found that (Scottish) English-learning 17- to 19-month-olds learned reduplicated labels for novel objects better than non-reduplicated labels. Diminutivized variants, which include /i/ epenthesis in English (e.g., *doggy*), are also common in CDS [though again with cross-linguistic variation in rates, CITES]. Moore and Bergelson [-@moore2024wordform] found that diminutives were the most common type of label variation observed in a corpus of 6- to 17-month-old (American) English-learning infants. Critically, hearing a higher proportion of both reduplicated words and diminutivized words has been linked to faster vocabulary growth from 9 to 21 months for (Scottish) English learners [@ota2018choo]. Additionally, both of these types of label variation have been shown to facilitate word segmentation [@ota2018reduplication; @kempe2007diminutives], and in doing so, could support word learning [CITE].

What these findings do not address is how the use of multiple variants in the *same* interaction could support children's word learning. We consider attention as a plausible mechanism by which label variation could facilitate---rather than hinder---word learning, even over short timescales. Just as CDS as a register is generally preferred over adult-directed speech [ADS, @manybabies2020quantifying], certain features of CDS variants may heighten engagement across repeated labeling instances [CITES]. 

Despite competing possibilities for the effect of label variaion on children's word learning, no studies to date have directly tested how *consistent versus variable labels* impact children's ability to learn new words. The present study addresses this gap by manipulating the presence and type of label variation in a controlled, lab-based novel word learning task. In an eye-tracking study using a looking-while-listening (LWL) design [@fernald2008looking; @swingley2000spoken], English-hearing toddlers learned novel word-object mappings across three within-subjects conditions. In the *consistent* condition, toddlers heard repeated exposures to the exact same standard label. In two variation conditions, toddlers heard repetitions of the standard label in addition to two label variants. The *typical variation* condition featured label variants common in English CDS, including diminutivized and reduplicated word forms. The *atypical variation* condition featured phonologically altered word forms unattested in English CDS. Looking time measures were used to assess children's word-recognition accuracy, and pupil size synchrony measures [@nencheva2021moment] were used to examine children's moment-to-moment engagement during learning.
...
Moment-to-moment attention, indexed by pupil size synchrony, was higher in both variation conditions relative to the consistent condition, and was highest in the typical variation condition. These results suggest reliable differences in children's engagement with the labeling sentences across conditions. Although pupil size synchrony during exposure did not reliably predict word-recognition accuracy during test, the trend toward a positive association in the typical variation condition is consistent with prior findings linking synchrony to learning [@nencheva2021moment]. Together, these findings point to attentional engagement as a plausible---but not definitively established---mechanism by which label variation (particularly of the type that children encounter naturalistically) could facilitate novel word learning over short timescales.
